...
from app.models import PodcastFeedResponse, StoredPodcast
...
class PodcastStorageService:
    ...
    def get_podcast(self, podcast_id: str) -> StoredPodcast | None:
    ...
    def get_podcast_feed(self, page: int = 1, page_size: int = 10, sort_by: str = "created_at") -> PodcastFeedResponse:
        ...
        try:
            ...
            return PodcastFeedResponse(podcasts=page_podcasts, total_count=total_count, page=page, page_size=page_size)
    ...
    def get_audio_file_path(self, podcast_id: str) -> Path | None:
