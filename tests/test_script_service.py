...
class TestScriptService:
    ...
    def test_validate_script_json_invalid_structure(self):
        ...
        invalid_json = {"segments": "not a list"}
    ...
    def test_validate_script_json_missing_turns(self):
        ...
        invalid_json = {"multiSpeakerMarkup": {}}
    ...
    def test_validate_script_json_empty_turns(self):
        ...
        invalid_json = {"multiSpeakerMarkup": {"turns": []}}
    ...
    def test_chunk_turns_by_words_min_first_chunk(self):
        ...
        turns = [
            ...
            {
                "text": "This is a much longer sentence that should help meet the minimum word count requirement for the first chunk.",
                "speaker": "Jay",
            },
